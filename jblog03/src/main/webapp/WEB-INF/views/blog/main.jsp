			...
			<div id="content">
				...
				<ul class="blog-list">
					<c:forEach var="postVo" items="${postVo }">
						<li><a href="${pageContext.request.contextPath}/blog/${postVo.categoryId}/${postVo.id}">${postVo.title }</a> <span>${postVo.regDate}</span></li>
					</c:forEach>
				</ul>
			</div>
		</div>
		...
		<div id="navigation">
			...
			<ul>
				<c:forEach var="categoryVo" items="${categoryVo }">
					<li><a href="${pageContext.request.contextPath}/blog/${categoryVo.blogId }/${categoryVo.id }">${categoryVo.name }</a></li>
				</c:forEach>
				</ul>
		</div>
